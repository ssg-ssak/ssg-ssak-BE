package ssgssak.ssgpointuser.domain.coupon.presentation;
...
import ssgssak.ssgpointuser.domain.coupon.application.CouponServiceImpl;
import ssgssak.ssgpointuser.domain.coupon.dto.*;
import ssgssak.ssgpointuser.domain.coupon.vo.*;
